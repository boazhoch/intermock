...
const resolve_file_imports_1 = require("../../src/lib/resolve-file-imports");
...
const import_1 = require("./test-data/importExportSpecifier/import");
...
describe('Intermock TypeScript: Mock tests', () => {
    ...
    it('should generate mock for imported interfaces', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        return runTestCase(`${__dirname}/test-data/importExportSpecifier/import.ts`, 'Foo', import_1.expectedImportExportSpecifier.Foo, { importsResolver: resolve_file_imports_1.setImportExportSpecifier });
    }));
});
